...
public class Pentagon extends Shape{
    ...
    public Pentagon(int xPosition, int yPosition, Color shapeColor, int[] xPoints, int[] yPoints, int numPoints) {
    ...
    public void drawShape(Graphics g) {
        ...
        g2d.fill(path); // Fill the shape with the specified color
